...
Weather & External Public & Server-held API key & Simple tool $\rightarrow$ UI $\rightarrow$ result \\
Spotify/GitHub & External Auth & OAuth2 (proxied) & Full auth flow, token custody \\
\bottomrule
\end{tabularx}
